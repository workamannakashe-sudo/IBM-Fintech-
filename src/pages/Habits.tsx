    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300 text-slate-900 dark:text-white">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        ...
        <div className="rounded-2xl border border-slate-200/80 dark:border-zinc-800 bg-white dark:bg-[#121217] p-5 shadow-sm text-center flex flex-col items-center justify-center">
          ...
          <h3 className="font-display text-xl font-bold text-slate-900 dark:text-white">{streak} Day Streak</h3>
          ...
          {calendarDays.map((d) => (
            <div
              ...
              className={`heatmap-cell aspect-square rounded-lg flex items-center justify-center text-[10px] font-bold transition-all relative group cursor-pointer ${
                d.active
                  ? "bg-teal-600 dark:bg-cyan-500 text-white dark:text-slate-950 shadow-md shadow-teal-500/25"
